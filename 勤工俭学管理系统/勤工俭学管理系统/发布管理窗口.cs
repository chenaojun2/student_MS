...
namespace 勤工俭学管理系统
{
    public partial class 发布管理窗口 : Form
    {
        ...
        private void 发布管理窗口_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select Work_time as 工作时间,Work_adress as 工作地址,Work_number as 工作人数,Work_salary as 时薪,Work_content as 工作内容" +
                ",Full_salary as 全勤奖,Atend_max 全勤奖需求,Work_duration as 工作时长 from work where Flag = " + 0+ "";
            myadp = new MySqlDataAdapter(sql, conn);//获取未被审核的工作
            myds = new DataSet();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update work set Flag = 1 where Work_time = '" + dataGridView1.Rows[a].Cells[0].Value.ToString() + "' and Work_adress = '" + dataGridView1.Rows[a].Cells[1].Value.ToString() + "'" +
                        " and Work_content = '" + dataGridView1.Rows[a].Cells[4].Value.ToString() + "'"; //审核成功点击发布更新flag值
